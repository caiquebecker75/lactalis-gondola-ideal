/* ==========================================================================
   Configuracao do jogo "Monte sua gondola ideal" | Lactalis Brasil
...
window.SEARA_CONFIG = {
  ...
  evento: "Convenção Lactalis 2026",

  /* Senha do painel de dados (painel.html) */
  senhaPainel: "lactalis2026",
  ...
  lgpd: "Autorizo o uso dos meus dados de contato pela Lactalis e pela 75 LAB para fins deste evento."
};
